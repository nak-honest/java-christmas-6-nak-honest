...
public class WeekendDiscountTest {
    ...
    static Stream<Arguments> provideMenusAndDiscountAmount() {
        return Stream.of(
                Arguments.of(Map.of(MainMenu.BARBECUE_RIB, 1), 2_023),
                Arguments.of(Map.of(MainMenu.BARBECUE_RIB, 1, MainMenu.T_BONE_STEAK, 1), 4_046),
                Arguments.of(Map.of(MainMenu.BARBECUE_RIB, 3), 6_069),
                Arguments.of(Map.of(MainMenu.BARBECUE_RIB, 2, AppetizerMenu.TAPAS, 1), 4_046),
                Arguments.of(Map.of(DessertMenu.ICE_CREAM, 3), 0),
    ...
    static Stream<Arguments> provideMenus() {
        return Stream.of(
                Arguments.of(Map.of(MainMenu.BARBECUE_RIB, 1)),
                Arguments.of(Map.of(MainMenu.BARBECUE_RIB, 1, MainMenu.T_BONE_STEAK, 1)),
                Arguments.of(Map.of(MainMenu.BARBECUE_RIB, 3)),
                Arguments.of(Map.of(MainMenu.BARBECUE_RIB, 2, AppetizerMenu.TAPAS, 1)),
